...
.method public preloadPlan(Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$PreloadOptions;Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;II)V
    ...
    iget v7, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$PreloadOptions;->flags:I

    .line 101
    move/from16 v8, p4

    invoke-virtual {v5, v6, v8, v7}, Lcom/android/systemui/shared/system/ActivityManagerWrapper;->getRecentTasks(III)Ljava/util/List;
    ...
    invoke-virtual {v2, v6, v15, v1}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateActivityIcon(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/app/ActivityManager$TaskDescription;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v10, Landroid/app/ActivityManager$RecentTaskInfo;->taskDescription:Landroid/app/ActivityManager$TaskDescription;
    ...
    iget v5, v10, Landroid/app/ActivityManager$RecentTaskInfo;->userId:I
    ...
    iget v8, v10, Landroid/app/ActivityManager$RecentTaskInfo;->userId:I
    ...
    .line 161
    invoke-virtual {v5, v7, v8}, Lcom/android/systemui/shared/recents/LockStateController;->getTaskLockState(Ljava/lang/String;I)Z

    move-result v5

    .line 166
    .local v5, "isTaskLocked":Z
    new-instance v7, Lcom/android/systemui/shared/recents/model/Task;

    iget-boolean v8, v10, Landroid/app/ActivityManager$RecentTaskInfo;->supportsSplitScreenMultiWindow:Z
