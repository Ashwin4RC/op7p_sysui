...
.method static constructor <clinit>()V
    ...
    const-string v1, "com.oem.rftoolkit"
...
.method private static resolveConfig(Lorg/json/JSONArray;)V
    ...
    invoke-virtual {v5, v6}, Lcom/android/systemui/power/OverHeatProtector;->setSkinEnable(Z)V

    .line 277
    .end local v4    # "enable":Ljava/lang/String;
    :cond_6
    const-string/jumbo v4, "skin_temp"
    ...
    invoke-virtual {v5, v6}, Lcom/android/systemui/power/OverHeatProtector;->setSkinTemp(I)V

    .line 281
    .end local v4    # "temp":Ljava/lang/String;
    :cond_7
    const-string/jumbo v4, "skin_path"
    ...
    invoke-virtual {v5, v4}, Lcom/android/systemui/power/OverHeatProtector;->setSkinPath(Ljava/lang/String;)V

    .line 285
    .end local v4    # "path":Ljava/lang/String;
    :cond_8
    const-string v4, "enable_anti_false"
    ...
    invoke-virtual {v5, v6}, Lcom/android/systemui/power/OverHeatProtector;->setAntiFalseEnable(Z)V

    .line 289
    .end local v4    # "enable":Ljava/lang/String;
    :cond_9
    const-string v4, "anti_false_count"
    ...
    invoke-virtual {v5, v6}, Lcom/android/systemui/power/OverHeatProtector;->setAntiFalseCount(I)V
